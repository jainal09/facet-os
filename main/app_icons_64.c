 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font mi2.ttf --size 64 --bpp 4 --format lvgl --range 0xE871,0xE91D,0xE63E,0xE322 --no-compress --lv-include lvgl.h -o app_icons_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1201, .adv_w = 1024, .box_w = 60, .box_h = 43, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 2491, .adv_w = 1024, .box_w = 48, .box_h = 48, .ofs_x = 8, .ofs_y = 8},
    {.bitmap_index = 3643, .adv_w = 1024, .box_w = 54, .box_h = 51, .ofs_x = 5, .ofs_y = 5}
};
