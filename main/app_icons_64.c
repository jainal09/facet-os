 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font MaterialIcons-Regular.ttf --size 64 --bpp 4 --format lvgl --range 0xE871,0xE91D,0xE63E,0xE322,0xE39E,0xE405,0xE878 --no-compress --lv-include lvgl.h -o app_icons_64.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x1d, 0xc1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x10,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2659, .adv_w = 1024, .box_w = 32, .box_h = 48, .ofs_x = 16, .ofs_y = 8},
    {.bitmap_index = 3427, .adv_w = 1024, .box_w = 60, .box_h = 43, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 4717, .adv_w = 1024, .box_w = 48, .box_h = 48, .ofs_x = 8, .ofs_y = 8},
    {.bitmap_index = 5869, .adv_w = 1024, .box_w = 48, .box_h = 54, .ofs_x = 8, .ofs_y = 8},
    {.bitmap_index = 7165, .adv_w = 1024, .box_w = 54, .box_h = 51, .ofs_x = 5, .ofs_y = 5}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x7c, 0xe3, 0x31c, 0x54f, 0x556, 0x5fb
};
